...
$(document).on("click", ".colA .colB > h5", function () {
  // Toggle the "active" class on the parent .colB element and get its siblings within the same colA
  $(this)
    .parents(".colA")
    .find(".colB")
  ...
  // Toggle the visibility of the corresponding .txt element within the same colA
  $(this)
    .parents(".colA")
    .find(".colB > .txt")
